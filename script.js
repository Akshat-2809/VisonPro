...
tl6.to("#page22 #center-page22",{
  top:"-50%"
})


function canvas1(){
  const canvas = document.querySelector("#page28>canvas");
const context = canvas.getContext("2d");
